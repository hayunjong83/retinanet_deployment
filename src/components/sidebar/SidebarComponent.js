          ...
          >
            ...
            <Column className={css(styles.menuItemList)}>
              <MenuItemComponent
                ...
                onClick={() => this.props.onChange("Object Detection")}
                active={this.props.selectedItem === "Object Detection"}
              />
              <MenuItemComponent
                title="Classification"
                icon={IconClassification}
                onClick={() => this.props.onChange("Classification")}
                active={this.props.selectedItem === "Classification"}
              />
